package Parcial_Mejores_Ejercicios.ContarFrecuencias;
...
public class Pregunta7 {
    ...
    public static void main(String[] args) {
        ...
        List<String> nombres = java.util.Arrays.asList("Ana", "Luis", "Ana", "Beto", "Beto", "Juan","Luis","Ana");
        System.out.println(Solution.contarFrecuencias(nombres));

        List<String> colores = java.util.Arrays.asList("rojo", "verde", "verde", "verde", "azul", "rojo","rojo","celeste");
        System.out.println(Solution.contarFrecuencias(colores));

        List<String> lenguajes = java.util.Arrays.asList("Java", "java", "JAVA", "java", "Java");
